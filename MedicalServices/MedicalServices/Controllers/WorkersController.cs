...
namespace MedicalServices.Controllers
{
    public class WorkersController : Controller
    {
        ...
        #region Delete
        [Authorize(Roles = "SuperAdmin")]
        public async Task<IActionResult> DeleteDoctor(string id, bool ReturnToBranch = false, int BranchId = 0, bool RetuenToWorkers = false)
        {

            ApplicationUser applicationUser=usersRepository.GetById(id);
            if (applicationUser != null)
            {
                await imageRepository.DeleteImageInWroot(applicationUser.Image);
            }
        ...
        [Authorize(Roles = "SuperAdmin")]
        public async Task<IActionResult> DeleteAssastant(string id, bool ReturnToBranch = false, int BranchId = 0, bool RetuenToWorkers = false)
        {
            ApplicationUser applicationUser = usersRepository.GetById(id);
            if (applicationUser != null)
            {
        ...
        [Authorize(Roles = "SuperAdmin")]
        public async Task<IActionResult> DeleteAccoutant(string id, bool ReturnToBranch = false, int BranchId = 0, bool RetuenToWorkers = false)
        {
            ApplicationUser applicationUser = usersRepository.GetById(id);
            if (applicationUser != null)
            {
        ...
        [Authorize(Roles = "SuperAdmin")]
        public async Task<IActionResult> DeleteAdmin(string id, bool ReturnToBranch = false, int BranchId = 0, bool RetuenToWorkers = false)
        {
                        ApplicationUser applicationUser=usersRepository.GetById(id);
            if (applicationUser != null)
            {
